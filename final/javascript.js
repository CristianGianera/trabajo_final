...
$("#email").click(
 ...
 window.open("https://mail.google.com/mail/u/0/?view=cm&to=cristiangianera@gmail.com");
});

$("#git").click(
 function Redireccionar() {
 window.open("https://github.com/CristianGianera");
});

$("#face").click(
 function Redireccionar() {
 window.open("https://www.facebook.com/cristiangianera/");
});